package com.montos.mqtt.config;


/**
 * @author : MentosL
 * @date : 2023/4/28 22:13
 */
import com.montos.mqtt.service.impl.MqttCallbackHandler;
...
public class MqttConfig {
    ...
    public MessageHandler mqttOutbound() {
        //创建消息处理器
        MqttPahoMessageHandler messageHandler = new MqttPahoMessageHandler(clientId+"_pub",senderMqttClientFactory());
        //设置消息处理类型为异步
